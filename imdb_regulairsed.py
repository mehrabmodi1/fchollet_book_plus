...
#model.add(layers.Dense(16, kernel_regularizer = regularizers.l1_l2(l1 = 0.0005, l2 = 0.001), activation = 'relu', input_shape = (10000,)))
#model.add(layers.Dense(16, kernel_regularizer = regularizers.l1_l2(l1 = 0.0005, l2 = 0.001), activation = 'relu'))
